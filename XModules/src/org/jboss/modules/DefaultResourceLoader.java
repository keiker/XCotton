 ...
 */
public abstract class DefaultResourceLoader implements AutoCloseable {
     ...
     */
    abstract ClassSpec getClassSpec(String fileName) throws IOException;
     ...
     * @throws IOException if an I/O error occurs
     */
    abstract PackageSpec getPackageSpec(String name) throws IOException;
     ...
     */
    abstract String getLibrary(String name);
     ...
     */
    abstract Collection<String> getPaths();
